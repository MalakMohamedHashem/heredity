...
def main():
    ...
    filename = r"C:\Users\pc\Desktop\intelligent programming\heredity\heredity\data\family0.csv"
...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person, info in people.items():
        ...
        # Calculate trait probability given gene count
        trait_prob = PROBS["trait"][gene][trait] if trait is not None else 1.0
